...
# KRAS G12D
#-------------------------------------------------------------------------------
SNV_C5 <- list("KRAS G12D",allele =1)
...
m_engine$add_exposure(time = 0, coefficients = c(SBS1 = 0.1, SBS4 = 0.4, SBS5 = 0.2, SBS13 = 0.20,SBS2 = 0.1, ID1 = 0.4, ID2 = 0.2,ID3 = 0.4))

# SBS11 active after chemotherapy
m_engine$add_exposure(time = timing$chemo1_start, coefficients = c(SBS1 = 0.05, SBS5 = 0.05, SBS31 = 0.8,SBS13 = 0.05,SBS2 = 0.05, ID1 = 0.75, ID2 = 0.2,ID3 = 0.05))
m_engine$add_exposure(time = timing$chemo1_end, coefficients = c(SBS1 = 0.1, SBS4 = 0.1, SBS5 = 0.25, SBS13 = 0.35,SBS2 = 0.2,ID1 = 0.5, ID2 = 0.3,ID3 = 0.2))
