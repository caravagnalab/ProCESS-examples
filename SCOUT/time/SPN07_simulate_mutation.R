...
samples_forest <- load_sample_forest("/orfeo/cephfs/scratch/area/lvaleriani/races/ProCESS-examples/SCOUT/test/sample_forest.sff")
phylo_forest <- m_engine$place_mutations(samples_forest, 500, 200)
phylo_forest$save("/orfeo/cephfs/scratch/area/lvaleriani/races/ProCESS-examples/SCOUT/test/phylo_forest.sff")
...
saveRDS(object = resource_usage, file = 'SPN07_mutations.rds')
