...
saveRDS(file = '/orfeo/cephfs/scratch/area/lvaleriani/races/ProCESS-examples/interpretation/performance_cluster.rds',
        object = results)
...
mutations <- lapply(1:nrow(combs), FUN = function(i){
  ...
  bind_rows()
saveRDS(file = '/orfeo/cephfs/scratch/area/lvaleriani/races/ProCESS-examples/interpretation/performance_mutations.rds', 
        object = mutations)
