process CNA_REPORT_COMBINATION {
    ...
    ### Save reports     
    ggsave(plt, file = paste0('report.png'), height = 14, width = 8)
    ...
    saveRDS(list(ascat = ASCAT_output, ascat_long = joint_segmentation_ascat_long,
                ...
                cnvkit = CNVkit_output, cnvkit_long = joint_segmentation_cnvkit_long), file = paste0('data.rds'))
    saveRDS(sequenza_df, file = paste0('sequenza_bp.rds'))
