...
#Rscript ${path}/assign_signature/assign.R --spn_id "${spn}" --coverage "$coverage" --purity "$purity" --signature "SigProfiler"
Rscript ${path}/assign_signature/assign.R --spn_id "${spn}" --coverage "$coverage" --purity "$purity" --signature "BASCULE"
