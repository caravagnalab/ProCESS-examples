...
#SBATCH --nodes=1
#SBATCH --job-name=seq_mut_normal_copy
...
src="${base_dir}/${spn}/sequencing/normal/purity_${purity}/data/"
dst="${dst_root}/${spn}/sequencing/normal/purity_${purity}/data/"
...
rsync -av \
    ...
    --exclude="mutations/seq_results_muts_${spn}_*.rds" \
    --exclude="parameters/" \
    --exclude="resources/" \
    "${src}" \
    "${dst}"
